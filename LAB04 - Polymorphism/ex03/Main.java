...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Universidade UFU = new Universidade("Univdersidade Federal de Uberlândia", 1969);
        Estudante estudantes[] = new Estudante[3];

        estudantes[0] = new EstudanteGraduacao("João", "Rua 1", "TCC 1");
        estudantes[1] = new EstudanteMestrado("Maria", "Rua 2", "Ciência da Computação", "Banco de Dados", "Acadêmico", "Banquinho de Dados");
        estudantes[2] = new EstudanteDoutorado("Maria", "Rua 2", "Ciência da Computação", "Machine Learning e Redes Neurais", "Perdeu o emprego rs");
